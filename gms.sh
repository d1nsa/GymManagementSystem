...
password ()  
  {
    ...
    read -sp "  Enter Password : " pass;   #makes password typing invisible
...
function add_members () { 
    ...
    if [ -e $file_name ]
     then
            ...
            echo -e "$1 : \c"
            read  id
              if [ `check $id` -eq 0 ] #Checks to see if the ID already exists or not.
                then 
...
function check() { 
        #Checks to see the existence of a string in the file.
...
function close_app() {
    ...
    echo -e "\tThank you!"
    sleep 0.5
    echo -e "\n\t\t   ..........Developed by https://github.com/d1nsa"
    echo -e "\n\n \t\t\t                                  "
    echo -e "-----------------------------------------------------------------------"
    sleep 0.4
    echo -e "\n Good Bye!!!\n\n"
